...
class LinkedList {
  ...
  removeHead() {
    ...
    if (this.head.next === null) {
      // create a new reference to our current head to return value
  ...
  contains(value) {
    ...
    const searchLinkedList = (node) => {
      ...
      // base case 2: end of linked list
      if (node.next === null) return false;
      // call our function recursively, passing it next node in LL
      return searchLinkedList(node.next);
    };
    // call our recursive function on our first linked node
