...
// const linkListObj = new LinkedList();

// linkListObj.addToTail('german');
// linkListObj.addToTail('carlos');
// linkListObj.addToTail('freddy');
// linkListObj.addToTail('yamelin ');
// linkListObj.addToTail('sameni');

// console.log(JSON.stringify(Object.entries(linkListObj) , null, 4));
